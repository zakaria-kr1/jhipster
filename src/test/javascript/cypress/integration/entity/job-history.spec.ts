...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2022-02-23T09:16').should('have.value', '2022-02-23T09:16');

      cy.get(`[data-cy="endDate"]`).type('2022-02-22T23:25').should('have.value', '2022-02-22T23:25');
